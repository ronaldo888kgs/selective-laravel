                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <div style="margin-top:10px">
                            ...
                            <input style="margin-top:5px" type="email" class="form-control" disabled="disabled" id="new-mailer-category" name="new-mailer-category">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success" style="width:100%" id="btnAddContact" name="btnAddContact">Add</button>
                    {{-- onclick="addData()" --}}
                </div>
            </div>
        </div>
